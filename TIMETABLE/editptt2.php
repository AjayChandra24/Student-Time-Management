...
<form method="post" action="editptt1.php">
    ...
    font-size: 25px; text-align: center; font-weight: bold;
    font-family: 'Avant Garde', Avantgarde, 'Century Gothic', CenturyGothic, 'AppleGothic', sans-serif;">Edit Your PersonalTimeTable</legend>
